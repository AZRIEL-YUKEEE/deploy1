...
st.title("🎯 K-Means Clustering: Sex & Course vs Aptitude Scores")
...
if uploaded_file is not None:
    ...
    def generate_insight(x_col, y_col, avg_x, avg_y, overall_mean_x):
        """
        Generate meaningful textual interpretation for clusters.
        """
        # Interpret Y variable (Sex or Course)
        if y_col == "sex":
